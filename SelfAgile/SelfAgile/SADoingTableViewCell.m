...
@interface SADoingTableViewCell ()
...
@implementation SADoingTableViewCell
...
- (void)layoutSubviews
{
    ...
    CGFloat prefixWidth = [UIKitCustomUtils getTextWidthWithText:DoingDueDateLabelText andMaxHeight:15.0f andFont:[UIFont systemFontOfSize:11.0f]];
