...
- (id)init
{
    ...
    if (self)
    {
        ...
        _messageVisible = NO;
        _messageBarOffset = 64.0f;//[[UIApplication sharedApplication] statusBarFrame].size.height;
...
+ (void)initialize
{
	...
	{
        // Colors (background)
        kTWDefaultMessageBarStyleSheetErrorBackgroundColor = [UIColor customColorRed];
        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor customColorDefault];
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor customColorYellow];
        
        // Colors (stroke)
        kTWDefaultMessageBarStyleSheetErrorStrokeColor = [UIColor customColorRed]; // orange
        kTWDefaultMessageBarStyleSheetSuccessStrokeColor = [UIColor customColorDefault]; // green
        kTWDefaultMessageBarStyleSheetInfoStrokeColor = [UIColor customColorYellow]; // blue
    }
}
